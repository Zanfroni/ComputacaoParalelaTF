...
double best_value = 0; // Variavel global representando o melhor valor encontrado
...
int main(int argc, char** argv) {
    ...
    if(my_rank == 0){
        ...
        while(slaves > 0){
            ...
            if(message == REQUEST){
                ...
                // Agora ele tem que mandar para o escravo o indice para a soma
                seed = work;
    ...
    // LOGICA DO ESCRAVO
        ...
        while(1){
            ...
            // Declara o indice para realizar as operacoes de soma
            int r = message;
